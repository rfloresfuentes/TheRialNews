class CommentsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @comment.update(comment_params)
        format.html { redirect_to @comment, notice: "El comentario se ha actualizado." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to comments_path, status: :see_other, notice: "El comentario ha sido eliminado." }
